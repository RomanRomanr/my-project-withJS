import{a as m,i as C,S as G,N as J,P as Z,K as Q,A as X,I as Y}from"./assets/vendor-Hl2mOz2K.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function s(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(a){if(a.ep)return;a.ep=!0;const r=s(a);fetch(a.href,r)}})();const n="/my-project-withJS/assets/icons-DBWj8NZj.svg",ee="https://furniture-store-v2.b.goit.study/api";async function te(){return(await m.get(`${ee}/categories`)).data}function se(e){const t=document.querySelector(".list-categories");if(!t)return;const s=e.map(({_id:o,name:a})=>`
      ...
      `).join("");t.innerHTML=s}function I(e){function t(s){const{images:o,name:a,price:r,color:i,_id:c}=s;return` <li class="furniture-catalog-items">
        ...
        </li>`}function de(e){return e.map(le).join("")}const ue=m.create({baseURL:"https://furniture-store-v2.b.goit.study/api"});async function me(e){const{data:t}=await ue.get(`/furnitures/${e}`);return t}const y={modal:document.querySelector(".modal"),modalWindow:document.querySelector(".modal-window")};function ge(e=0){const t=Math.round(e*2)/2,s=Math.floor(t),o=t%1!==0;return`rating star-svg value-${s}${o?" half":""}`}function fe(e=0){return`
    <div class="${ge(e)}">
      <div class="star-container">
        ${[...Array(5)].map(()=>`
          <div class="star">
...
`).map(t=>t.trim()).filter(Boolean).map(t=>`<p>${t}</p>`).join("")}function ve(e){const t=Number(e);return Number.isNaN(t)?`${e} грн`:`${t.toLocaleString("uk-UA")} грн`}function h(e=""){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function ye(e){var q;if(!y.modalWindow||!e)return;const t=Array.isArray(e.images)?e.images:[],[s="",o="",a=""]=t,r=h(e.name||e.title||"Товар"),i=h(((q=e.category)==null?void 0:q.name)||e.category||"Категорія не вказана"),c=ve(e.price),g=e.description||"",z=h(String(e.sizes||e.size||"Не вказано")),U=e.rate||e.rating||0,V=e.color||e.colors||[],L=h(e.alt||e.name||e.title||"Товар"),d="/img/placeholder.jpg",W=s||d,_=o||s||d,K=a||s||d;y.modalWindow.innerHTML=`
